class CalendarSchedule {
    ...
    onSelect(e) {
        this.formEvent?.reset(),
            ...
            (this.modalTitle.text = "رویداد جدید اضافه کنید"),
            this.modal.show(),
