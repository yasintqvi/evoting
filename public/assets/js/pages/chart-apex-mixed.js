var colors = ["#727cf5", "#0acf97"],
    ...
    tooltip: {
      ...
      y: {
        formatter: function (o) {
          return void 0 !== o ? o + " هزار تومان" : o;
        },
      },
    },
    grid: { borderColor: "#f1f3fa", padding: { bottom: 5 } },
  ...
  options = {
    ...
    tooltip: {
      ...
      y: {
        formatter: function (o) {
          return void 0 !== o ? o.toFixed(0) + " امتیاز" : o;
        },
      },
    },
    grid: { borderColor: "#f1f3fa", padding: { bottom: 5 } },
