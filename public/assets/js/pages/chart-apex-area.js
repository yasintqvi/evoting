var colors = ["#fa6767"],
  ...
  options = {
    ...
    series: [{ name: "سهام یاس", data: series.monthDataSeries1.prices }],
  ...
  options = {
    ...
    colors: (colors = dataColors ? dataColors.split(",") : colors),
    series: [
      { name: "سری 1", data: [31, 40, 28, 51, 42, 109, 100] },
      { name: "سری 2", data: [11, 32, 45, 32, 34, 52, 41] },
    ],
    legend: { offsetY: 5 },
    xaxis: { categories: ["اردیبهشت", "دی", "خرداد", "تیر", "شهریور", "مهر", "آبان"] },
      ...
      var e = ["#6c757d"],
        ...
        a =
          (a && (e = a.split(",")),
          {
            ...
            xaxis: {
              type: "datetime",
                min: new Date("11 Nov 2013").getTime(),
              tickAmount: 6,
            },
        ...
        .addEventListener("click", function (e) {
          t(e),
            o.updateOptions({
              xaxis: {
                min: new Date("11 Nov 2013").getTime(),
                max: new Date("11 Nov 2013").getTime(),
              },
            });
        }),
        document
  ...
  optionsarea2 = {
    ...
    series: [{ name: "کامیت", data: githubdata.series }],
...
(colors = ["#39afd1", "#fa5c7c", "#727cf5"]),
  ...
  (options = {
    series: [
      { name: "محصول 1", data: dataSet[0] },
      { name: "محصول 2", data: dataSet[1] },
      { name: "محصول 3", data: dataSet[2] },
    ],
  ...
  (options = {
    ...
    series: [
      {
        name: "شبکه",
        data: [
          { x: "فروردین 23 1402", y: null },
          { x: "فروردین 24 1402", y: 44 },
          { x: "فروردین 25 1402", y: 31 },
          { x: "فروردین 26 1402", y: 38 },
          { x: "فروردین 27 1402", y: null },
          { x: "فروردین 28 1402", y: 32 },
          { x: "فروردین 29 1402", y: 55 },
          { x: "فروردین 30 1402", y: 51 },
          { x: "فروردین 31 1402", y: 67 },
          { x: "اردیبهشت 01 1403", y: 22 },
          { x: "اردیبهشت 02 1403", y: 34 },
          { x: "اردیبهشت 03 1403", y: null },
          { x: "اردیبهشت 04 1403", y: null },
          { x: "اردیبهشت 05 1403", y: 11 },
          { x: "اردیبهشت 06 1403", y: 4 },
          { x: "اردیبهشت 07 1403", y: 15 },
          { x: "اردیبهشت 08 1403", y: null },
          { x: "اردیبهشت 09 1403", y: 9 },
          { x: "اردیبهشت 10 1403", y: 34 },
          { x: "اردیبهشت 11 1403", y: null },
          { x: "اردیبهشت 12 1403", y: null },
          { x: "اردیبهشت 13 1403", y: 13 },
          { x: "اردیبهشت 14 1403", y: null },
        ],
      },
    ],
    chart: {
    ...
    title: { text: "نظارت بر شبکه" },
    tooltip: { intersect: !0, shared: !1 },
    theme: { palette: "palette1" },
    xaxis: { type: "datetime" },
    yaxis: { title: { text: "بایت دریافت شده" } },
  });
(chart = new ApexCharts(
