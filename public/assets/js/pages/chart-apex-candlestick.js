var colors = ["#0acf97", "#fa5c7c"],
  ...
  options =
      ...
      (colors = dataColors.split(",")),
    {
      ...
      series: [{ name: "مقدار", data: seriesDataLinear }],
  ...
  options =
      ...
      (colors = dataColors.split(",")),
    {
      ...
      title: { text: "نمودار شمعدان - دسته بندی محور ایکس", align: "left" },
  ...
  options =
      ...
      (colors = dataColors.split(",")),
    {
      ...
      title: { text: "نمودار شمعدان", align: "left" },
      stroke: { width: [3, 1] },
        ...
        custom: [
          ...
          function (e) {
            ...
            return (
              ...
              '</span></div><div>بالا: <span class="value">' +
              e.globals.seriesCandleH[t][a] +
              '</span></div><div>پایین: <span class="value">' +
