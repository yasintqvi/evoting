...
<style>
    ...
    .stat-value.date    { font-size: 17px; color: #1a1a2e; font-weight: 600; }
    ...
    .icon-date    { background: #ede9fe; color: #7c3aed; }
    ...
    .ratio-row { margin-bottom: 0.85rem; }
    ...
    .fill-present { background: linear-gradient(90deg, #16a34a, #4ade80); }
    .fill-absent  { background: linear-gradient(90deg, #dc2626, #f87171); }
</style>
        ...
        <div class="stats-col">
            ...
            <div class="stat-card">
                <div>
                    ...
                    <div class="stat-value present" id="present-count">{{ $event->present_count }}</div>
                </div>
            ...
            <div class="stat-card">
                <div>
                    ...
                    <div class="stat-value absent" id="absent-count">{{ $event->absent_count }}</div>
                </div>
            ...
            <div class="stat-card">
                <div>
                    ...
                    <div class="stat-value date">{{ $event->created_at->format('Y/m/d') }}</div>
                </div>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function updateUI(present, absent) {
        ...
        presentPctEl.textContent   = pPct + '%';
        absentPctEl.textContent    = aPct + '%';
