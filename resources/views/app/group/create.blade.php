...
<div class="page-title-head d-flex align-items-sm-center flex-sm-row flex-column gap-2">
    <div class="flex-grow-1">
        <h4 class="fs-18 fw-semibold mb-0">شما در حال ایجاد گروه جدیدی هستید</h4>
    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="mt-2">
                            <div class="form-check form-check-inline d-inline-block me-3">
                                ...
                                <label class="form-check-label" for="customRadio3"> تعاونی</label>
                            </div>
                            <div class="form-check form-check-inline d-inline-block me-3">
                                <input type="radio" id="customRadio4" name="type"
                                    value="{{ App\Enums\GroupType::SPECIAL->value }}"
                                    {{ old('type', request()->input('type')) == App\Enums\GroupType::SPECIAL->value ? 'checked' : '' }}
                                    class="form-check-input">
                                <label class="form-check-label" for="customRadio4"> سهامی خاص</label>
                            </div>

                            <div class="form-check form-check-inline d-inline-block me-3">
                                <input type="radio" id="customRadio4" name="type"
                                    value="{{ App\Enums\GroupType::OPEN->value }}"
                                    {{ old('type', request()->input('type')) == App\Enums\GroupType::SPECIAL->value ? 'checked' : '' }}
                                    class="form-check-input">
                                <label class="form-check-label" for="customRadio4">آزاد</label>
                            </div>
                        ...
                        <div class="d-flex gap-2 mt-3 {{ old('type') == App\Enums\GroupType::SPECIAL->value ? '' : 'hidden' }}"
                            id="shareInput">
                            <div class="flex-grow-1">
