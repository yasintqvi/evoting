        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('user.group.permissions.update', [$group,$user]) }}" method="POST">
                        @csrf
                        @method('PUT')
                                            ...
                                            <div class="form-check mb-2">
                                                <input type="checkbox"
                                                    ...
                                                    {{ (is_array(old('permissions')) && in_array($permission->id, old('permissions'))) ||
                                                       (!old() && in_array($permission->id, $user->getGroupPermissions($group)->pluck('id')->toArray())) ? 'checked' : '' }}>
                                ...
                                <div id="selected-permissions" class="mt-2">
                                    ...
                                    @foreach($otherPermissions as $permission)
                                        <div class="badge bg-primary me-2 mb-2 d-inline-flex align-items-center">
                                            ...
                                            <input type="hidden" name="permissionsRecord[]"
