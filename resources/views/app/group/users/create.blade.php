...
<div class="row">
    <div class="card col-lg-6">
        ...
        <!-- فرم ایجاد کاربر -->
        <form id="new-user-form" action="{{ route('group.users.store', $group->slug) }}" method="post"
            style="display: block;">
            @csrf
            <div class="card-body">
                <div class="row">
        ...
        <!-- فرم کاربران فعال -->
        <form id="active-users-form" action="{{ route('group.users.store', $group->slug) }}" method="post"
            style="display: none;">
            @csrf
            <div class="card-body">
                <!-- انتخاب کاربران -->
