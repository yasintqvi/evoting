                    ...
                    <div class="table-responsive border border-dashed rounded px-2 py-1">
                        <table class="table table-borderless m-0">
                            <tbody>
                                ...
                                <tr>
                                    <td>تعداد عضو علی‌البدل:</td>
                                    <td class="text-dark fw-medium fs-14">
                                        {{ $election['substitute_member_count'] }}
                                    </td>
                                </tr>
                ...
                <div class="card">
                    <div class="card-header border-bottom border-dashed d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex align-items-center">
                            <a href="{{ route('election-rounds.show', [$group, $election, $electionRound->id]) }}"
                                class="btn btn-outline-success mx-2">دیدن نتایج</a>
                            @if ($election['rounds']->where('is_active', true)->exists())
                                <form action="{{ route('voting.terminate', [$group, $election]) }}" class="p-0 m-0"
                                    method="post">
                                    @csrf
