    ...
    <div class="card col-lg-6">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <input type="datetime-local" class="form-control" id="starts_at" name="starts_at"
                            value="{{ old('starts_at', $election->starts_at ? $election->starts_at->format('Y-m-d\TH:i') : '') }}">
                        @error('starts_at')
                        <span class="strong text-danger font-weight-bold">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <input type="datetime-local" class="form-control" id="ends_at" name="ends_at"
                            value="{{ old('ends_at', $election->ends_at ? $election->ends_at->format('Y-m-d\TH:i') : '') }}">
                        @error('ends_at')
                        <span class="strong text-danger font-weight-bold">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="col-12">
                    <div class="mb-3">
                        ...
                        <small class="text-muted">کاربرانی که انتخاب می‌کنید اجازه شرکت در رأی‌گیری را نخواهند داشت.</small>
                        @error('blocked_users')
        ...
        <div class="card-footer">
            <div class="text-end mb-3 d-flex gap-2">
                <a href="{{ route('elections.index', [$group, $event]) }}" class="btn btn-secondary">انصراف</a>
