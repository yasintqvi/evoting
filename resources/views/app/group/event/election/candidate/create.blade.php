...
@section('content')
    ...
    <form action="{{ route('candidates.store', [$group, $event, $election]) }}" method="post">
        @csrf
                    ...
                    <div class="col-md-12">
                        <div class="mb-3">
                            ...
                            <select class="form-select my-1 my-md-0 me-sm-3" name="main_candidates_ids[]"
                                id="main_candidates" data-toggle="select2"
                                data-required-count="{{ $requiredCandidatesCount }}" multiple>
