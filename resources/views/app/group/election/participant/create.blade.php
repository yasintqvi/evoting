            ...
            <div class="row" id="participants-container">
                ...
                <div class="col-md-4 participant-form" id="participant-form-0">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="participants[0][normal_stock_count]" id="participants.0.normal_stock_count" placeholder="تعداد سهام عادی" required="">
                ...
                <div class="col-md-4 participant-form" id="participant-form-0">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="participants[0][prefered_stock_count]" id="participants.0.prefered_stock_count" placeholder="تعداد سهام ممتاز" required="">
...
<script>
    ...
    document.getElementById('add-participant-btn').addEventListener('click', function() {
        ...
        const newParticipantForm = `
            ...
            <div class="col-md-4 participant-form" id="participant-form-${participantIndex}">
                <div class="mb-3">
                    <label for="participants.${participantIndex}.normal_stock_count" class="form-label">تعداد سهام عادی: {{ $election->normal_stock_count }}</label>
                    <input type="text" class="form-control" name="participants[${participantIndex}][normal_stock_count]" id="participants.${participantIndex}.normal_stock_count" placeholder="تعداد سهام عادی" required="">
            ...
            <div class="col-md-4 participant-form" id="participant-form-${participantIndex}">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="participants[${participantIndex}][prefered_stock_count]" id="participants.${participantIndex}.prefered_stock_count" placeholder="تعداد سهام ممتاز" required="">
