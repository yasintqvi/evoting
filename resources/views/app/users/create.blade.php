        ...
        <div class="card col-lg-6">
            ...
            <form id="new-user-form" action="{{ route('users.store') }}" method="post" style="display: block;">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="mt-1">
                                <label for="group1" class="form-label">افزودن به شرکت</label>
            ...
            <form id="active-users-form" action="{{ route('users.store') }}" method="post" style="display: none;">
                ...
                <div class="card-body">
                    ...
                    <div class="col-lg-12">
                        <div class="mb-3">
                            <label for="group" class="form-label">افزودن به شرکت</label>
                ...
                <div class="card">
                    <div class="card-header col-lg-12 border-bottom border-dashed d-flex align-items-center">
                        ...
                        <div class="col-lg-6 text-end">
                            <a href="{{ asset('assets/excel/sample.xlsx') }}" download class="header-title"
                                style="cursor: pointer">فایل نمونه اکسل</a>
                        </div>
                    </div>
