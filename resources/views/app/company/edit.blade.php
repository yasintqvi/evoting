...
@section('content')
    <div class="page-title-head d-flex align-items-sm-center flex-sm-row flex-column gap-2">
        <div class="flex-grow-1">
            <h4 class="fs-18 fw-semibold mb-0">ویرایش شرکت</h4>
        </div>
        ...
        <div class="col-lg-7">
            <div class="card">
                <div class="card-header border-bottom border-dashed">
                    <h4 class="card-title mb-0">ویرایش شرکت</h4>
                </div>
                            ...
                            <div class="d-flex gap-2 mt-3 {{ old('type', $company->type) == App\Enums\CompanyType::SPECIAL->value ? '' : 'hidden' }}" id="shareInput">
                                <div class="flex-grow-1">
                                    ...
                                    <input type="number" id="normal_stock_count" name="normal_stock_count"
                                        ...
                                        value="{{ old('normal_stock_count', $company->normal_stock_count) }}">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <input type="number" id="prefered_stock_count" name="prefered_stock_count"
                                        ...
                                        value="{{ old('prefered_stock_count', $company->prefered_stock_count) }}">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <input type="number" id="prefered_stock_weight" name="prefered_stock_weight"
                                        ...
                                        value="{{ old('prefered_stock_weight', $company->prefered_stock_weight) }}">
                        ...
                        <div>
                            <div>
                                ...
                                <textarea class="form-control mt-1" name="description" id="description" rows="3"
                                    placeholder="درباره ی شرکت بنویسید">{{ old('description', $company->description) }}</textarea>
                                @error('description')
                                    <span class="text-danger font-weight-bold">{{ $message }}</span>
                                @enderror
                            </div>
