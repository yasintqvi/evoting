                ...
                <div class="tab-content">
                    <div class="tab-pane active show" id="description" role="tabpanel">
                        <form class="col-lg-12"
                            action="{{ route('participants.store', [$company->slug, $election->id]) }}" method="post">
                            @csrf
                            <div>
                    ...
                    <div class="tab-pane" id="review" role="tabpanel">
                        <div class="row ">
                            <form
                                action="{{ route('participants.store-table-participen', [$company->slug, $election->id]) }}"
...
@if (in_array($election->type, [App\Enums\ElectionType::PRIVATE_JOINT, App\Enums\ElectionType::PRIVATE_JOINT_WITH_88]))
<form class="card col-lg-5" action="{{ route('participants.import', [$company->slug, $election->id]) }}"
