    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between border-bottom border-light">
                ...
                <div>
                    <a href="{{ route('roles.create') }}" class="btn btn-success bg-gradient"><i class="ti ti-plus me-1"></i>ایجاد نقش جدید</a>
                </div>
            </div>
                        ...
                        <tr>
                            ...
                            <td class="pe-3">
                                <div class="hstack gap-1 justify-content-end">
                                    <a href="{{ route('roles.edit', $role->id) }}" class="btn btn-secondary btn-sm"><i class="ti ti-edit"></i></a>
                                    @if(!in_array($role->name, [App\Enums\Role::Manager->value]))
                                    <form action="{{ route('roles.delete', $role->id) }}" method="POST" class="d-inline delete-role-form">
                                        @csrf
                                        @method('DELETE')
