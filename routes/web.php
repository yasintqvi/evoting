...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('{group:slug}')->group(function () {
        ...
        Route::prefix('events')->group(function () {
            Route::get('/', [EventController::class, 'index'])->can(Permission::VIEW_GROUP_EVENT)->name('events.index');
            Route::get('/show/{event}', [EventController::class, 'show'])->name('events.show');
            Route::get('/create', [EventController::class, 'create'])->can(Permission::CREATE_GROUP_EVENT)->name('events.create');
            Route::post('/create', [EventController::class, 'store'])->can(Permission::CREATE_GROUP_EVENT)->name('events.store');
            Route::get('/edit/{event}', [EventController::class, 'edit'])->can(Permission::EDIT_GROUP_EVENT)->name('events.edit');
            Route::put('/update/{event}', [EventController::class, 'update'])->can(Permission::EDIT_GROUP_EVENT)->name('events.update');
            Route::delete('/delete/{event}', [EventController::class, 'destroy'])->can(Permission::DELETE_GROUP_EVENT)->name('events.delete');

            Route::prefix('{event}/elections')->group(function () {
