...
if (!function_exists('isVoterOnly')) {
    /**
     */
    function isVoterOnly(): bool
    {
        $user = user();
        ...
        if (
            $user->hasRole(\App\Enums\Role::Manager->value) ||
            $user->hasRole(\App\Enums\Role::Secretary->value)
        ) {
            return false;
        }
